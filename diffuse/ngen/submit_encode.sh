...
#
# USAGE:
#   ./submit_encode.sh                    # Encode with defaults
#   ./submit_encode.sh --batch-size 128   # Custom batch size
#   ./submit_encode.sh --time 2:00:00     # Custom time limit
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Usage: $0 [--batch-size N] [--time HH:MM:SS] [--vod-dir DIR] [--output-dir DIR] [--vae-checkpoint PATH]"
            exit 1
            ;;
    esac
done
